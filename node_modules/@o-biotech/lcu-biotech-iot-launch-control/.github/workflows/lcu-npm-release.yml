...
on:
  push:
    branches: [integration,main,feature/**,hotfix/**]
  pull_request:
    branches: [integration,main,feature/**,hotfix/**]
  workflow_dispatch:
...
env:
  ...
  Repository: lcu-biotech-iot-launch-control
  Output: ./build
  ...
  build:
    ...
    steps:
      ...
      - name: npm build & publish
        if: ${{ !!env.DeployCommand && steps.package_json_exists.outputs.files_exists == 'true' }}
